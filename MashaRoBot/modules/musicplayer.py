...
__mod_name__ = "Song Player"
__help__ = """
          》** 🎶𝕄𝐢𝚜𝚜 𝕄𝚞𝚜𝐢𝚌ℤ🎵 ** 《
            
 TIANA_VCPLAYERplays music in your group's voice chat
 
 Assistant name >> ꧁ @MissMusicZ ꧂
 
⚙️Setting up 
1) Make bot admin
2) Start a voice chat
3) Try `/play [song name]` for the first time by an admin
*) If userbot joined enjoy music, If not add @MissMusicZ to your group and retry
  Commands
...
=>> More tools 📲
  ...
  /userbotjoin: Invite @MissMusicZ Userbot to your chat
