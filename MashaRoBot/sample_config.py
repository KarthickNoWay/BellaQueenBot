...
class Config(object):
    ...
    OWNER_ID = 1300772714  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Karthick_46"
    ...
    DONATION_LINK = https://t.me/karthick_46  # EG, paypal
    CERT_PATH = None
    PORT = 5000
